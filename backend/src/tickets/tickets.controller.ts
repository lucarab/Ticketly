...
export class TicketsController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Ticket erstellen',
    description:
      'Benutzer: nur eventId senden; userId wird vom Token gesetzt, Status automatisch "active". Administratoren/Manager: eventId und userId angeben; Status optional.',
  })
  @ApiBody({
    type: CreateTicketDto,
    description: 'Rollenabhängige Anforderungen siehe Beschreibung',
  })
  @ApiCreatedResponse({
  ...
  @ApiOperation({
    ...
    description:
      'Benutzer sehen nur eigene Tickets. Administratoren/Manager sehen alle Tickets.',
  })
  @ApiOkResponse({
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Ticket per ID abrufen',
    description: 'Benutzer können nur eigene Tickets abrufen, sonst 403.',
  })
  ...
  @ApiUnauthorizedResponse({ description: 'Nicht autorisiert' })
  @ApiForbiddenResponse({
    description: 'Nicht erlaubt für Benutzer (fremdes Ticket)',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Nur Administratoren/Manager dürfen Tickets ändern. Benutzer erhalten 403.',
  })
  @ApiParam({ name: 'id', type: Number, description: 'Ticket-ID', example: 42 })
  @ApiBody({ type: UpdateTicketDto })
  @ApiOkResponse({
    description: 'Ticket aktualisiert',
    type: TicketResponseDto,
  })
  @ApiBadRequestResponse({ description: 'Ungültige Eingaben' })
  @ApiNotFoundResponse({ description: 'Ticket nicht gefunden' })
  ...
  @Delete(':id')
  @ApiOperation({
    summary: 'Ticket löschen',
    description:
      'Nur Administratoren/Manager dürfen Tickets löschen. Benutzer erhalten 403.',
  })
  @ApiParam({ name: 'id', type: Number, description: 'Ticket-ID', example: 42 })
  ...
  @Post('scan')
  @ApiOperation({
    summary: 'Ticket per UUID scannen und validieren',
    description:
      'Nur Administratoren/Manager dürfen Tickets scannen. Benutzer erhalten 403.',
  })
