...
export class EventsController {
  ...
  @ApiOperation({
    ...
    description:
      'Nur Administratoren/Manager können Events erstellen. Benutzer erhalten 403.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Benutzer sehen nur veröffentlichte Events. Administratoren/Manager sehen alle.',
  })
  @ApiOkResponse({
  ...
  @ApiOperation({
    ...
    description: 'Benutzer können nur veröffentlichte Events sehen, sonst 403.',
  })
  ...
  @ApiUnauthorizedResponse({ description: 'Nicht autorisiert' })
  @ApiForbiddenResponse({
    description: 'Nicht erlaubt für Benutzer (nicht veröffentlicht)',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Nur Administratoren/Manager können Events bearbeiten. Benutzer erhalten 403.',
  })
  @ApiParam({ name: 'id', type: Number, description: 'Event-ID', example: 42 })
  ...
  @ApiOperation({
    ...
    description:
      'Nur Administratoren/Manager können Events löschen. Benutzer erhalten 403.',
  })
  @ApiParam({ name: 'id', type: Number, description: 'Event-ID', example: 42 })
